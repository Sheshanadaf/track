...
import { View, StyleSheet, Text, SafeAreaView, ImageBackground,TouchableOpacity,Image } from 'react-native';
...
const TimeTableScreen = () => {
  ...
  const handleButton1 = () => {
    // Navigate to Screen1
    navigation.navigate('CreateTimeTbale');
  };
  ...
  return (
    <ImageBackground source={require('../../../assets/cre_tt.jpg')} style={styles.background}>
